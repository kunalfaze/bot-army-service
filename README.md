...
At this point, you may get a error saying:

```
ImportError: cannot import name 'soft_unicode' from 'markupsafe' (/home/shaktiman/faze/bot-army-service/venv/lib/python3.8/site-packages/markupsafe/__init__.py)
```
...
for more info you can check [GitHub issue](https://github.com/aws/aws-sam-cli/issues/3661)